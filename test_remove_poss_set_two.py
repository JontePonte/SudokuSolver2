...
class TestRemovePossSetTwo(unittest.TestCase):
    ...
    def test_remove_extra_poss_field_REMOVE(self):
        row_1 = self.rows[1]    # The second row has a "0" in the first field
        # second row: [0, 0, 6, 8, 0, 5, 3, 0, 0]
    ...
    def test_remove_extra_poss_field_DONT(self):
        row_1 = self.rows[1]    # The second row has a "0" in the first field
        # second row: [0, 0, 6, 8, 0, 5, 3, 0, 0]
    ...
    def test_remove_extra_poss_if_two_box2(self):
        ...
        box_1[1].possible = {1}
        box_1[2].possible = {2}
        box_1[3].possible = {1,2,3,4,7}
        box_1[4].possible = {2}
        box_1[5].possible = {3}
        box_1[6].possible = {1,2,3,4,7}
        box_1[7].possible = {3,4,7}
        box_1[8].possible = {3}
        ...
        # the numbers 8 and 9 only appears in field 2 and 6.
        # all other possibilities should be removd from field 2 and 6
        self.assertEqual(box_1_result[0].possible, {1})
        self.assertEqual(box_1_result[1].possible, {1})        
        self.assertEqual(box_1_result[2].possible, {2})        
        self.assertEqual(box_1_result[3].possible, {1,2,3,4,7})
        self.assertEqual(box_1_result[4].possible, {2})
        self.assertEqual(box_1_result[5].possible, {3})        
        self.assertEqual(box_1_result[6].possible, {1,2,3,4,7})        
        self.assertEqual(box_1_result[7].possible, {3,4,7})        
        self.assertEqual(box_1_result[8].possible, {3})